...
import { Clock, UserCheck, Settings, Inbox } from 'lucide-react'
...
interface InboxSectionProps {
  ...
  onRespondToEvaluation: (evaluation: Evaluation) => void
}
    ...
    <>
      <div className="flex flex-col mb-4 gap-1">
        ...
        <FilterBar
          ...
          onExport={() => exportEvaluationsToCSV(sorted, 'inbox-evaluations.csv')}
        />
      </div>
          ...
          <div className="p-6">
            ...
            <div className="flex items-start justify-between mb-4">
              ...
              <div className="flex items-center space-x-2 flex-shrink-0">
                <Badge className="gap-1 bg-red-100 text-red-800 dark:bg-red-900 dark:text-red-200 animate-pulse">
                  <Clock className="h-3 w-3" />
                  Awaiting Response
                </Badge>
              </div>
